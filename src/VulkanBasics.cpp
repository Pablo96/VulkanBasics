...
App::App(const char* in_name)
{
	glfwInit();
	
	glfwWindowHint(GLFW_RESIZABLE, GLFW_FALSE);
	glfwWindowHint(GLFW_CLIENT_API, GLFW_NO_API);
	window = glfwCreateWindow(800, 600, in_name, nullptr, nullptr);
...
{
	/* Debuggers use this structure to give information
	 * (This is optional)
	 */
